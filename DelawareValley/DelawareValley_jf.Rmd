...
dvMSA <- 
  st_read("C:/Users/ferna/Downloads/dv_counties.shp") 

lc_2011 = raster("C:/Users/ferna/Downloads/lc_2011_clip_Resample.tif")
lc_2021 = raster("C:/Users/ferna/Downloads/lc_2021_clip_Resample.tif")
...
```{r}
# setting up api key 
census_api_key("37a6dab04ca5ae304ea1fb038d4eada1a58c221a", overwrite = TRUE, install = TRUE)
```
- Bucks County
- Chester County
- Delaware County
...
ggplot() +
  ...
  scale_fill_manual(values = palette5,
                    labels=quintileBreaks(dvpop_2011,"total_pop"),
...
ggplot() +
  ...
  scale_fill_manual(values = palette5,
                    labels=quintileBreaks(dvpop_2021,"total_pop"),
                   name="Quintile/nBreaks") +
