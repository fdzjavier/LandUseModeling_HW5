...
auMSA <- st_read("/Users/luyiiwong/Documents/GitHub/LandUseModeling_HW5/AustinData/AustinMSA_v2geojson.json") 
...
ggplot() +
  ...
  geom_sf(data=auHighways, colour = "red") +
...
highway_raster <- raster(auHighways)
