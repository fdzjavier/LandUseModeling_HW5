...
njMSA <- 
  st_read("/Users/luyiiwong/Documents/GitHub/LandUseModeling_HW5/Data/nj_counties_msa.geojson")
...
```
```{r}
#resampling for lc change before reclassification 
...
compareRaster(lc_2011, lc_2021_resampled, extent = FALSE, rowcol = FALSE, crs = TRUE)
...
```{r}
# rename this to lc_change2
lc_change2 <- developed_2011+developed_2021_resampled
